...
#knownEncodings = [emericFaceEncode, nancyFaceEncode, jojoFaceEncode, donFaceEncode]
#names = ['Emeric Daumarie', 'Nancy Pelosi', 'George Avocat-Gros', 'Donald Trup']
...
while True:
    ...
    cv2.imshow('myFaces', unknownFace)
